class Application4
{
	...
	Application4(String appName, float version)
	{
		System.out.println("invoking Application4 in constructor");
	...
	void displayDeveloperCountryStateSize()
	{
		if(this.developer.address!=null)
		{
			...
			{
				Address4 address= developer.address[i];
