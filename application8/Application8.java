class Application8
{
	...
	Application8(String appName, float version)
	{
		System.out.println("invoking Application8 in constructor");
	...
	void displayDeveloperCountryStateSize()
	{
		if(this.developer.address!=null)
		{
			...
			{
				Address8 address= developer.address[i];
